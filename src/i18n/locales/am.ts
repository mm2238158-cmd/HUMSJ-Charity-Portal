...
const am: Translations = {
  ...
  auth: {
    ...
    forgotPasswordTitle: "የይለፍ ቃልዎን ዳግም ያስተካክሉ",
    ...
    brandHeadline: "ይስጡ። ይገናኙ። ይንከባከቡ።",
    brandSubline: "የሁምስጄ አባላት በጋራ የሚሰጡበት፣ የሚከታተሉበትና በጎ አድራጎታችንን የምናሳድግበት የታመነ ቤት።",
    valueProp1: "ግልጽ የወር መዋጮ ከማስረጃ ጋር",
    valueProp2: "የባንክ ደረጃ ደህንነትና የተረጋገጡ መለያዎች",
    valueProp3: "በእምነት የተሳሰሩ ወንድሞችና እህቶች ማህበረሰብ",
    pwWeak: "ደካማ የይለፍ ቃል",
    pwFair: "መካከለኛ — ቁጥሮች ወይም ምልክቶች ጨምር",
    pwGood: "ጥሩ የይለፍ ቃል",
    pwStrong: "ጠንካራ የይለፍ ቃል",
    terms: "በመቀጠል የውል እና የግላዊነት መመሪያችንን ተቀብለሃል።",
    emailPlaceholder: "you@example.com",
    namePlaceholder: "ለምሳሌ፡ አብዲ መሐመድ",
    signingIn: "በመግባት ላይ…",
