const en = {
  ...
  auth: {
    ...
    brandHeadline: "Contribute. Connect. Care.",
    brandSubline: "A trusted home for HUMSJ members to give, track, and grow our charity together.",
    valueProp1: "Transparent monthly contributions with proof",
    valueProp2: "Bank-grade security and verified accounts",
    valueProp3: "A community of brothers and sisters in faith",
    pwWeak: "Weak password",
    pwFair: "Fair — add numbers or symbols",
    pwGood: "Good password",
    pwStrong: "Strong password",
    terms: "By continuing you agree to our Terms and Privacy Policy.",
    emailPlaceholder: "you@example.com",
    namePlaceholder: "e.g. Abdi Mohammed",
  ...
  superAdmin: {
    ...
    rebalance: "Rebalance assignments",
    rebalanced: "Rebalanced",
    unassignable: "unassignable",
    genderRule: "Male admins handle male students; female admins handle female students.",
    genderMismatch: "Assigned admin's gender doesn't match this student",
    mismatch: "mismatch",
    noSameGenderAdmin: "No same-gender admin available",
    reassignHint: "Only same-gender admins are shown.",
